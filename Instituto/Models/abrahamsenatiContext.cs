...
{
    public partial class abrahamsenatiContext : DbContext
    {
        public abrahamsenatiContext()
        {
        }

        public abrahamsenatiContext(DbContextOptions<abrahamsenatiContext> options)
            : base(options)
        {
        }
...
//                optionsBuilder.UseSqlServer("server=abrahamsenati.database.windows.net; database=abrahamsenati; User ID=AbrahamTO; Password=240803@To;");
//            }
//        }
